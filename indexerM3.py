...
if __name__ == "__main__":
    '''
    Main execution:
    1. Process all documents to build the index.
    2. Merge partial indexes.
    3. Accept user queries and perform searches.
    '''
    project_directory = "/Users/ashritakuppili/Desktop/Inf121/project3/DEV"

    print("\nProcessing the documents in the dataset directory...")
    ...
    while True:
        ...
        if doc_results:
            print_top_5_urls(doc_results, final_index, query)
        else:
